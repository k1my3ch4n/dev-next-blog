...
export const BLOG_POSTS: PostData[] = [
  ...
  { id: 20, postKey: "AIGithubActions",          externalUrl: "https://k1my3ch4ns.notion.site/AI-GitHub-Actions-2fdc98c1db058027be98e36eb972fb23", thumbnailKey: null, title: "AI + GitHub Actions",                   tags: ["AI", "GitHub Actions", "CI/CD"] },
  { id: 21, postKey: "toss-exam",                externalUrl: null, thumbnailKey: null, title: "토스 프론트엔드 챕터 과제",                 tags: ["취업", "코딩테스트"] },
  { id: 22, postKey: "syngrid",                  externalUrl: "https://syngrid.notion.site/Syngrid-32f193d73b2381c0bb27c5f245e23129?pvs=74", thumbnailKey: null, title: "Syngrid: Real-time Multi Viewport",     tags: ["프로젝트", "실시간"] },
